...
namespace CapitalEuropeiaGuarda.Controllers
{
    public class VeiculoesController : Controller
    {
        ...
        public VeiculoesController(CapitalEuropeiaGuardaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VeiculoId,Modelo,Marca,Max_lugares,Min_lugares")] Veiculo veiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VeiculoId,Modelo,Marca,Max_lugares,Min_lugares")] Veiculo veiculo)
        {
